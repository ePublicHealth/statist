...
# Form implementation generated from reading ui file 'frmAbout.ui'
#
# Created: Tue Aug 04 10:24:58 2009
...
class Ui_dlgAbout(object):
    def setupUi(self, dlgAbout):
        ...
        self.lblRevision = QtGui.QLabel(self.widget)
        self.lblRevision.setMaximumSize(QtCore.QSize(16777215, 14))
        self.lblRevision.setObjectName("lblRevision")
        self.verticalLayout.addWidget(self.lblRevision)
        self.lblLogo = QtGui.QLabel(self.widget)
    ...
    def retranslateUi(self, dlgAbout):
        dlgAbout.setWindowTitle(QtGui.QApplication.translate("dlgAbout", "About Statist", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.lblRevision.setText(QtGui.QApplication.translate("dlgAbout", "SVN revision:", None, QtGui.QApplication.UnicodeUTF8))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), QtGui.QApplication.translate("dlgAbout", "About Statist", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), QtGui.QApplication.translate("dlgAbout", "Acknowledgements", None, QtGui.QApplication.UnicodeUTF8))
